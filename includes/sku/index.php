<?php 
    $sku_data = mysqli_query($connection, "SELECT * FROM idm250_sku");
    $sku = mysqli_fetch_all($sku_data, MYSQLI_ASSOC);
?>

<header class="main-header">
    <h1 class="main-heading">SKU Management</h1>
    <a href="?view=create-sku" class="primary-btn">Create SKU</a>
</header>
            ...
            <tr>
                ...
                <td class="col-actions">
                        ...
                        <form action="?view=delete-sku" method="post">
                            ...
                            <button class="icon-btn" type="submit" onclick="return confirm('Are you sure you want to delete SKU <?php echo htmlspecialchars($row['sku']); ?>?');">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
