            ...
            <tr>
                ...
                <td class="col-actions">
                    <?php if ($mpl['status'] === 'draft'): ?>
                        <form action="?view=send-mpl" method="post">
                            <input type="hidden" name="mpl_id" value="<?=$mpl['mpl_id']; ?>">
                            <button class="icon-btn" type="submit"
                                onclick="return confirm('Are you sure you want to send MPL <?=$mpl['reference_number']; ?>?');">
                        ...
                        <a href="?view=mpl-form&id=<?php echo $mpl['mpl_id']; ?>" class="icon-btn">
        ...
        <?php if (empty($mpls)): ?>
            <tr>
                <td colspan="6" class="empty-table">
                    ...
                    <p>No MPLs found. <a class="secondary-btn" href="?view=mpl-form">Create an MPL.</a></p>
                </td>
            </tr>
        <?php endif; ?>
    </tbody>
